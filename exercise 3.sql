...
/*8*/
select first_name,dbo.InitCap(first_name) from employees
...
select e.first_name,d.department_name from employees e join departments d on
e.department_id=d.department_id join locations l on d.location_id=l.location_id 
where l.city in(select l1.city from locations l1 where first_name='Trenna')
